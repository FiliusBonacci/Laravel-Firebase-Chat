                    ...
                    <div class="ui cards">
                      <div class="card">
                        ...
                        <div class="content">
                          ...
                          <div class="meta">
                            <span class="date">Zarejestrowany  {{Auth::user()->created_at->diffForHumans()}}</span>
                          </div>
                        </div>
                                    ...
                                    <div class="content">
                                        ...
                                        @if($user->isNew())
                                            <div class="ui yellow right ribbon label">
                                                <i class="star icon"></i> Nowy użytkownik
                                            </div>
                                        @else
                                            <div class="ui teal right ribbon label">
                                                <i class="user circle icon"></i> Użytkownik
                                            </div>
                                        @endif
                                        ...
                                        <div class="meta">
                                          Zarejestrowany {{$user->created_at->diffForHumans()}}
                                        </div>
